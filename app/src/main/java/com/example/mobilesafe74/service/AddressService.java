...
public class AddressService extends Service {
    ...
    private InnerCallReceiver mInnerCallReceiver;
    ...
    public void onCreate() {
        ...
        mInnerCallReceiver = new InnerCallReceiver();
        registerReceiver(mInnerCallReceiver,intentFilter);

        super.onCreate();
    }

    private class InnerCallReceiver extends BroadcastReceiver {
        @Override
...
//                | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE	默认能够被触摸
    ...
    public void onDestroy() {
        ...
        //取消拨出电话的监听
        if (mInnerCallReceiver!=null){
            unregisterReceiver(mInnerCallReceiver);
        }
        super.onDestroy();
    }
}
